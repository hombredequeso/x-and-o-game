...
exports.matchPatterns = exports.getWinner = void 0;
...
// ];
const getWinner = (winningPatterns) => (board) => {
...
const listReplace = (list, a, b) => list.map(x => (x == a) ? b : x);
exports.matchPatterns = ['x', 'o']
